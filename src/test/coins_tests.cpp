...
BOOST_AUTO_TEST_CASE(ccoins_add)
{
    ...
    CheckAddCoin(ABSENT, VALUE3, VALUE3, NO_ENTRY   , DIRTY|FRESH, false, true);
    CheckAddCoin(ABSENT, VALUE3, VALUE3, NO_ENTRY   , DIRTY      , true , false);
    CheckAddCoin(ABSENT, VALUE3, VALUE3, NO_ENTRY   , DIRTY      , true , true);
    CheckAddCoin(PRUNED, VALUE3, VALUE3, 0          , DIRTY|FRESH, false, false);
    CheckAddCoin(PRUNED, VALUE3, VALUE3, 0          , DIRTY|FRESH, false, true);
    CheckAddCoin(PRUNED, VALUE3, VALUE3, 0          , DIRTY      , true , false);
    CheckAddCoin(PRUNED, VALUE3, VALUE3, 0          , DIRTY      , true , true);
    ...
    CheckAddCoin(PRUNED, VALUE3, VALUE3, FRESH      , DIRTY|FRESH, true , true);
    ...
    CheckAddCoin(PRUNED, VALUE3, VALUE3, DIRTY      , DIRTY      , true , true);
    ...
    CheckAddCoin(PRUNED, VALUE3, VALUE3, DIRTY|FRESH, DIRTY|FRESH, true , true);
    ...
    CheckAddCoin(VALUE2, VALUE3, VALUE3, 0          , DIRTY      , true , true);
    ...
    CheckAddCoin(VALUE2, VALUE3, VALUE3, FRESH      , DIRTY|FRESH, true , true);
    ...
    CheckAddCoin(VALUE2, VALUE3, VALUE3, DIRTY      , DIRTY      , true , true);
    ...
    CheckAddCoin(VALUE2, VALUE3, VALUE3, DIRTY|FRESH, DIRTY|FRESH, true , true);
}
