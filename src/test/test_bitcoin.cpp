...
{
    // TokenPay: disable this test until further implementation of Params().GetConsensus().nCoinbaseMaturity
    //
    /*
...
TestChain100Setup::CreateAndProcessBlock(const std::vector<CMutableTransaction>& txns, const CScript& scriptPubKey)
{
    ...
    while (block.IsProofOfWork() && !CheckProofOfWork(block.GetHash(), block.nBits, chainparams.GetConsensus())) ++block.nNonce;
