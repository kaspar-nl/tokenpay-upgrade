...
void SendCoinsDialog::setModel(WalletModel *_model)
{
    ...
    if(_model && _model->getOptionsModel())
    {
        ...
        CAmount requiredFee = MIN_TX_FEE; //model->wallet().getRequiredFee(1000);
...
void SendCoinsDialog::processSendCoinsReturn(const WalletModel::SendCoinsReturn &sendCoinsReturn, const QString &msgArg)
{
    ...
    case WalletModel::AbsurdFee:
        msgParams.first = tr("A fee higher than XXXX is considered an absurdly high fee.");
        break;
...
void SendCoinsDialog::updateSmartFeeLabel()
{
    ...
    int returned_target;
    FeeReason reason;
    CFeeRate feeRate = MIN_TX_FEE; //CFeeRate(model->wallet().getMinimumFee(1000, coin_control, &returned_target, &reason));
